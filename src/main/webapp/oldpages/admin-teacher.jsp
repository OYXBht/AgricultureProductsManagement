			...
			<div class="row">
				<div class="col-sm-12">
					<div class="input-group">
						<div class="row">
							<form action="/StudentManage/admin/searchTeacher">
								<div class="col-sm-4">
									<input type="text" name="teacherNo" class="form-control" placeholder="请输入工号">
								</div>
								<div class="col-sm-4">
									<input type="text" name="teacherName" class="form-control" placeholder="请输入姓名">
								</div>
								<div class="col-sm-4">
									<div class="row">
										<div class="col-sm-4">
							  ...
							  <span class="input-group-btn">
								 <button class="btn btn-primary" type="submit">搜索</button>
										...
										<div class="col-sm-4">
											<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addTeacher">添加老师</button>
										</div>
									</div>
								</div>
							</form>
