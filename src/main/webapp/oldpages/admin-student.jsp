			...
			<div class="row">
				<div class="col-sm-12">
					<div class="input-group">
						<div class="row">
							<form action="/StudentManage/admin/searchStudent">
								<div class="col-sm-4">
									<input type="text" name="studentNo" class="form-control" placeholder="请输入学号">
								</div>
								<div class="col-sm-4">
									<input type="text" name="studentName" class="form-control" placeholder="请输入姓名">
								</div>
								<div class="col-sm-4">
									<div class="row">
										<div class="col-sm-4">
