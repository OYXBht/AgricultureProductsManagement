			...
			<div class="row">
				<div class="col-sm-12">
					<div class="input-group">
						<div class="row">
							<form action="/StudentManage/admin/searchCourse">
								<div class="col-sm-3">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" name="teacherNo" placeholder="请输入授课教师工号">
								</div>
								<div class="col-sm-3">
									<div class="row">
										<div class="col-sm-4">
										...
										<div class="col-sm-4">
											<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addCourse">添加课程</button>
										</div>
									</div>
								</div>
							</form>
